...
from models.modules import flow, thops, FlowAffineCouplingsAblation, GMITM
...
class FlowStep(nn.Module):
    ...
    def normal_flow(self, z, logdet, rrdbResults=None):
        ...
        if need_features or self.flow_coupling in ["condAffine", "condFtAffine", "condNormAffine"]:
            img_ft = getConditional(rrdbResults, self.position) # torch.Size([16, 320, 80, 80])

            # import pdb
            # pdb.set_trace()
            # TODO: Insert Gate?
            img_ft = self.gate(img_ft)
